            ...
            <div className='w-full bg-white px-2 rounded-xl shadow-md pt-2 col-start-1 col-end-4 md:col-start-2 md:col-end-3'>
                <div className='w-[95%] mx-auto py-2'>
                    <div className='w-full flex items-center justify-between pt-3'>
                        ...
                        <button className=''>
                            <AddRoundedIcon className="text-white bg-[#5f66e1] w-full rounded-md p-1 active:scale-[0.9] active:text-[#5f65e1e1] transition-all duration-100" fontSize='large' onClick={() => setPopUpToggle(!popUpToggle)} />
                        </button>
                    </div>
                </div>
