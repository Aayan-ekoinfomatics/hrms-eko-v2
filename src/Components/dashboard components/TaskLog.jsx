...
const TaskLog = () => {
    ...
    return (
        <>
            {/* desktop view */}
            <div className='hidden sm:flex col-start-1 col-end-4 row-start-1 md:row-end-3 w-full bg-white px-6 flex-col items-center rounded-xl shadow-md max-h-[370px]'>
                    ...
                    <div className='w-full flex items-center py-3'>
                        ...
                        <div className='w-full'>
                            <div className='w-full flex gap-3 items-end'>
                                <input type="search" className='outline-none px-2 py-1 w-[40%] ml-auto border-b border-b-[#5f66e1] text-[13px]' onChange={(e) => setSearchData(e.target.value)} />
                                <SearchRoundedIcon fontSize="medium" className="text-[#5f66e1]  w-[25px] cursor-pointer" />
                                <BorderColorRoundedIcon fontSize="medium" className="text-[#5f66e1] w-[25px] cursor-pointer active:scale-[0.9] active:text-[#5f65e1e1] transition-all duration-100" onClick={() => setPopUpToggle(!popUpToggle)} />
                            </div>
                        </div>
                    </div>
